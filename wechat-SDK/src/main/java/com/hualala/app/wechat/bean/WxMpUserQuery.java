package com.hualala.app.wechat.bean;
...
public class WxMpUserQuery implements Serializable {
   ...
   *
   * @param openids openid列表
   * @return {@link com.hualala.app.wechat.bean.WxMpUserQuery}
   */
  public com.hualala.app.wechat.bean.WxMpUserQuery add(List<String> openids) {
   ...
   * @return {@link com.hualala.app.wechat.bean.WxMpUserQuery}
   */
  public com.hualala.app.wechat.bean.WxMpUserQuery add(String openid, String lang) {
   ...
   * @return {@link com.hualala.app.wechat.bean.WxMpUserQuery}
   */
  public com.hualala.app.wechat.bean.WxMpUserQuery add(String openid) {
   ...
   * @return {@link com.hualala.app.wechat.bean.WxMpUserQuery}
   */
  public com.hualala.app.wechat.bean.WxMpUserQuery remove(String openid) {
   ...
   * @return {@link com.hualala.app.wechat.bean.WxMpUserQuery}
   */
  public com.hualala.app.wechat.bean.WxMpUserQuery remove(String openid, String lang) {
  ...
  public class WxMpUserQueryParam implements Serializable {
    ...
    private com.hualala.app.wechat.bean.WxMpUserQuery getOuterType() {
      return com.hualala.app.wechat.bean.WxMpUserQuery.this;
    }
